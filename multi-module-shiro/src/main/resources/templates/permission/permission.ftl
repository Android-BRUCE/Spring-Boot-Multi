...
<body class="gray-bg">
	...
	<script>
		function addModel() {
			...
			window.location.href = "${basePath}/permission/editPage/add";
		}
		...
		function editModel() {//编辑
			...
			if (row != null) {
				...
				window.location.href = "${basePath}/permission/editPage/" + row.id;
			} else {
		...
		function delData() {//删除
			XPage.DelData("${basePath}/permission/delete");
		}
		...
		$(document).ready(function() {
			var config = {
				title : '角色列表',
				url : '${basePath}/permission/getPermissionListWithPager',
