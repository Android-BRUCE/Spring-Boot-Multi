...
import com.highcharts.shiro.config.shiro.filter.KickoutSessionControlFilter;
...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(org.apache.shiro.mgt.SecurityManager securityManager) {
        ...
        // 从数据库获取
        List<SysPermissionInit> list = sysPermissionInitService.selectList(new EntityWrapper<SysPermissionInit>());
        /**
         * 对未登录的访问，授权可以访问的链接。根据sort排序 升序排序。
         */
        Collections.sort(list, new Comparator<SysPermissionInit>() {
            @Override
            public int compare(SysPermissionInit o1, SysPermissionInit o2) {
