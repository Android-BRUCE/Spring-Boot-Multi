...
import com.highcharts.shiro.mapper.SysUserMapper;
import com.highcharts.shiro.entity.FrontPage;
import com.highcharts.shiro.entity.SysUser;
import com.highcharts.shiro.entity.UserOnlineBo;
...
/*		for (Session session : sessions){
            ...
            UserOnlineBo userOnlineBo = new UserOnlineBo();
            BeanUtils.copyProperties(userOnlineBo,primaryPrincipal);
		//	UserOnlineBo userBo = new UserOnlineBo((SysUser)primaryPrincipal);
			System.out.println(userOnlineBo.getEmail());
