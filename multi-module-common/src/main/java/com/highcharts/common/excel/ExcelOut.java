...
public class ExcelOut<T> {
     ...
     * @throws Exception
     */
    public HSSFWorkbook getCustomerExcel(HttpServletResponse response, List<T> list, @NotNull String[] tableHeader) throws NullPointerException, Exception {
        if (list.isEmpty()) {
            logger.error("ExcelOut error,the parameter of list is null");
