 ...
 * @description: Redis 持久化文章：https://app.yinxiang.com/shard/s49/nl/10691737/8a24f0ce-3ae2-4f7e-b03f-6074852cadb7
 * @author: Brucezheng
...
public class RedisService {
     ...
     * @return
     */
    public long incrby(String key,long inrNum) {
        Jedis jedis = jedisPool.getResource();
        Long result = jedis.incrBy(key,inrNum);
        jedis.close();
        return result;
    }
