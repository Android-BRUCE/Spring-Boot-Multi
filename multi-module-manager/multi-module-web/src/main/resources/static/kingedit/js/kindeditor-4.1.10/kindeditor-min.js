...
(function (w, i) {
    ...
    function Qa(a, b, c) {
        ...
        var h = a.doc, f = [], k = a.cloneRange().down(), n = -1, q = -1, r = -1, m = -1, l = a.commonAncestor(),
    ...
    function Wa(a) {
        ...
        d.mousedown(function (a) {
            function j(a) {
                a.preventDefault();
                var b = f(V(a.target)), e = R((b.data("pos-x") || 0) + a.pageX - p),
            ...
            a.stopPropagation();
            var i = d.get(), r = t(b.css("left")), l = t(b.css("top")), m = b.width(), o = b.height(), p = a.pageX,
                s = a.pageY;
            e && e();
    ...
    if (!w.KindEditor) {
        ...
        var Ha = "4.1.10 (2013-11-23)", p = navigator.userAgent.toLowerCase(),
            o = p.indexOf("msie") > -1 && p.indexOf("opera") ==
                -1, Yb = p.indexOf("msie") == -1 && p.indexOf("trident") > -1,
            Y = p.indexOf("gecko") > -1 && p.indexOf("khtml") == -1, X = p.indexOf("applewebkit") > -1,
            Pa = p.indexOf("opera") > -1, ec = p.indexOf("mobile") > -1, fc = /ipad|iphone|ipod/.test(p),
            P = document.compatMode != "CSS1Compat", H = !w.getSelection,
            A = (p = /(?:msie|firefox|webkit|opera)[\/:\s](\d+)/.exec(p)) ? p[1] : "0", Ga = (new Date).getTime(),
            R = Math.round, f = {
                DEBUG: !1,
                VERSION: Ha,
                IE: o,
            ...
            gc = u("img,table,input,textarea,button"), La = u("pre,style,script"),
        ...
        E(M, {
            init: function (a) {
                ...
                var b = this.startContainer, c = this.startOffset, d = this.endContainer, e = this.endOffset, g, f, j,
                    k = 1;
        ...
        E(oa, {
            init: function (a) {
                ...
                var a = l(a, !0), b = this.sel, c = this.range.cloneRange().shrink(), d = c.startContainer,
                    e = c.startOffset, g = V(d), h = this.win, j, k = !1;
        ...
        E(S, {
            init: function (a) {
                ...
                if (this._alignEl) {
                    var g =
                            f(this._alignEl), h = g.pos(), c = R(g[0].clientWidth / 2 - c / 2),
        ...
        E(qa, S, {
            init: function (a) {
                ...
                var d = l(a.themesPath, ""), e = a.bodyClass, g = a.cssPath, h = a.cssData,
        ...
        E(ta, S, {
            init: function (a) {
                ...
                var c = a.title, d = f(a.body, this.doc), e = a.previewBtn, g = a.yesBtn, h = a.noBtn, j = a.closeBtn,
                    k = l(a.showMask, !0);
        ...
        Gb("core", function (a) {
            ...
            b.beforeGetHtml(function (a) {
                ...
                return a.replace(/(<(?:noscript|noscript\s[^>]*)>)([\s\S]*?)(<\/noscript>)/ig, function (a, b, c, d) {
                    ...
                    var a = I(a), b = ba(a.style || ""), c = pb(a["data-ke-tag"]), d = l(b.width, ""),
                        b = l(b.height, "");
                    /px/i.test(d) && (d = t(d));
                    /px/i.test(b) && (b = t(b));
                    c.width = l(a.width, d);
